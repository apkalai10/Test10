...
public class PbologinCredentailsData {
	
	
	public  List<String> A;
	public  List<String> B;

	public void readloginCredentailsexcel() throws IOException
	{
	
		 A = new ArrayList<String>();
		 B = new ArrayList<String>();
			FileInputStream excel = new FileInputStream("D:\\TestAutomation\\com.pbo\\testfiles\\LoginCredentials.xlsx");
